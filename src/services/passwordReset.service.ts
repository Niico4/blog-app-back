...
const sendPasswordResetEmail = async ({ name, email, token }: Props) => {
  ...
  <body>
    <div class="email-container">
      ...
      <div class="email-content">
        <p class="subtitle">Solicitud de Recuperación de Contraseña</p>
        <p>
          Hemos recibido una solicitud para restablecer la contraseña de tu
          cuenta. Para continuar con el proceso de recuperación, haz clic en el
          botón a continuación:
        </p>
        <div class="btn-container">
          <a href="${process.env.FRONTEND_BASE_URL}/auth/forgot-password/${token}" >
            <button>Restablecer Contraseña</button>
          </a>
        </div>
        <p>
          Si no solicitaste el restablecimiento de contraseña, ignora este
          correo.
        </p>
      </div>
