...
const emailResetPassword = async ({ name, email, token }: Props) => {
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Para completar tu cambio de contraseña y utilizar tu cuenta, por favor haz clic en el siguiente botón para generar una nueva contraseña:</p>
          <a href="${process.env.FRONTEND_URL}/auth/forgot-password/${token}" class="cta-button">
